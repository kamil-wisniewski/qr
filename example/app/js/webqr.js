/**
 * Ported to NextGate Project by artur.basak 2017
 *
 * archik408/jsqrcode forked from LazarSoft/jsqrcode
 *
 * Check original repository and demo
 *
...
(function() {
  ...
  qrcode.canvasId = "qr-canvas";
  qrcode.decode = function(src){

    if(arguments.length==0)
    {
      var canvas_qr = document.getElementById(qrcode.canvasId);
