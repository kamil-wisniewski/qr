...
class AppProvider {
  ...
  getCanvas(): any {
    return <any>document.getElementsByTagName('canvas')[0];
  }
  
  getVideo(): any {
    return <any>document.getElementsByTagName('video')[0];
  }
  
  getFlashObject(): any {
    return <any>document.getElementById('XwebcamXobjectX');
  }
}
